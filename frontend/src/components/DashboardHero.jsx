...
export default function DashboardHero({ current, icon: Icon, title, subtitle, badge, path }) {
  return (
    <div className="space-y-4">
      ...
      <div className="animate-fade-up relative overflow-hidden rounded-[1.8rem] border border-white/50 bg-[linear-gradient(120deg,rgba(8,47,73,0.96)_0%,rgba(6,78,120,0.9)_24%,rgba(14,165,233,0.9)_58%,rgba(59,130,246,0.92)_100%)] px-6 py-6 text-white shadow-[0_28px_80px_rgba(14,165,233,0.28)]" style={{ animationDelay: "0.08s" }}>
        ...
        <div className="relative flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[2rem] font-black tracking-[-0.05em] text-white sm:text-[2.4rem]">{title}</span>
              <span className="mt-1 text-sm font-medium text-cyan-50/82">{subtitle}</span>
            </div>
          </div>
